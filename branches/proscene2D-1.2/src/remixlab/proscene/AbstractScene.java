...
//Device registration
   ...
   */		
	...
	public abstract boolean unregisterCameraProfile(String cp);
	...
	public abstract void setDefaultShortcuts();
	
	protected abstract void initDefaultCameraProfiles();
	
	protected abstract void handleKeyboardAction(KeyboardAction id);
	
	protected abstract void handleCameraKeyboardAction(CameraKeyboardAction id);
	
	protected abstract void handleClickAction(ClickAction action);
}
