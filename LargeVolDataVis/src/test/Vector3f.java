...
/*
 * Code based in the Vector3f class from jMonkeyEngine.
 * Copyright (c) 2003-2009 jMonkeyEngine
 * All rights reserved.
 */

// From jMonkey code:
// http://code.google.com/p/jmonkeyengine/source/browse/trunk/src/com/jme/math/Vector3f.java
class Vector3f {
	/**
	 ...
	 */
	public float length() {
		return PApplet.sqrt(lengthSquared());
	}
	...
	public float distance(Vector3f v) {
		return PApplet.sqrt(distanceSquared(v));
	}
	 ...
	 * <p>
	 * If you want to display a class name, then use Vector3f.class.getName() or
	 * getClass().getName().
	 * </p>
	 * 
