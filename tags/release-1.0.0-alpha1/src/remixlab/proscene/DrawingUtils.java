...
public class DrawingUtils implements PConstants {
	...
	/**
	 * Draws a cylinder of width {@code w} and height {@code h}, along the {@code parent}
	...
	/**
	 * Draws a cone along the {@code parent} positive {@code z} axis, with its base centered at
	...
	/**
	 * Draws a truncated cone along the {@code parent} positive {@code z} axis, with its base centered at
	...
	/**
	 * Draws an axis of length {@code length} which origin correspond to the {@code parent}'s
	 ...
	 * <p> 
	 * Use {@link #drawArrow(PApplet, PVector, PVector, float)} to place the arrow in 3D. 
	 */
	public static void drawArrow(PApplet parent, float length, float radius) {
		...
		DrawingUtils.cylinder(parent, radius, length * (1.0f - head/coneRadiusCoef));
	 ...
	 * both defined in the current {@code parent} ModelView coordinates system.
	 * 
	 * @see #drawArrow(PApplet, float, float)
	 */
	...
	/**
	 * Convenience function that simply calls {@code drawGrid(parent, 100, nbSubdivisions)}
	 * 
	 * @see #drawGrid(PApplet, float, int)
	 */
	...
	/**
	 * Convenience function that simply calls {@code drawCamera(parent, camera, 170, true, 1.0f)}
	 * 
	...
	/**
	 * Convenience function that simply calls {@code drawCamera(parent, camera, 170, true, scale)}
	 * 
	 * @see #drawCamera(PApplet, Camera, int, boolean, float)
	 */
	...
	/**
	 * Convenience function that simply calls {@code drawCamera(parent, camera, color, true, 1.0f)}
	 * 
	 * @see #drawCamera(PApplet, Camera, int, boolean, float)
	 */
	...
	/**
	 * Convenience function that simply calls {@code drawCamera(parent, camera, 170, drawFarPlane, 1.0f)}
	 * 
	 * @see #drawCamera(PApplet, Camera, int, boolean, float)
	 */
	...
	/**
	 * Convenience function that simply calls {@code drawCamera(parent, camera, 170, drawFarPlane, scale)}
	 * 
	 * @see #drawCamera(PApplet, Camera, int, boolean, float)
	 */
	...
	/**
	 * Convenience function that simply calls {@code drawCamera(parent, camera, color, true, scale)}
	 * 
	 * @see #drawCamera(PApplet, Camera, int, boolean, float)
	 */
	...
	/**
	 * Convenience function that simply calls {@code drawCamera(parent, camera, color, drawFarPlane, 1.0f)}
	 * 
	 * @see #drawCamera(PApplet, Camera, int, boolean, float)
	 */
